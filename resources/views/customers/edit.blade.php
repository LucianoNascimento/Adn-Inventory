                    ...
                    <div class="box-body">
                       {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::text('phone', $result->phone, ['class' => 'form-control', 'placeholder' => 'Phone'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('email', 'Email')}}
                            {{Form::email('email', $result->email, ['class' => 'form-control', 'placeholder' => 'Email'])}}
                        </div>
                        <div class="form-group">
