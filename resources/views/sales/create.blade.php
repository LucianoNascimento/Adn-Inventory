    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <!-- /.box-header -->
                    <!-- form start -->
                    {!! Form::open(['action' => 'SalesInvoiceController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::text('do_no', '', ['class' => 'form-control', 'placeholder' => 'Do Number'])}}
                        </div>
